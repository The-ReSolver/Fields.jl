...
function myoptimise(u₀::VectorField{3, S}, Re::Real, Ro::Real; Δτ::Real=1e-3, maxiter::Int=1000, callback=()->(), verbose::Bool=false, rootopts::Options=Options(verbose=false)) where {S<:SpectralField}

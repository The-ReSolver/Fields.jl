...
function field2vec!(vec::Vector{T}, u::VectorField{N, <:SpectralField{Ny, Nz, Nt, <:Any, T}}) where {T, Ny, Nz, Nt}
...
function vec2field!(u::VectorField{N, <:SpectralField{Ny, Nz, Nt, <:Any, T}}, vec::Vector{T}) where {Ny, Nz, Nt, T}
